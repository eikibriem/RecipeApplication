...
public class RecipeFetchId {

    private static final String TAG = "RecipeFetchId";

    public Recipe fetchRecipeId(String recipeName) {
        Recipe recipe = new Recipe();
        try {
            String url = Uri.parse("http://10.0.2.2:8080/m/recipes/getId/" + recipeName)
                    .buildUpon()
                    .build().toString();
